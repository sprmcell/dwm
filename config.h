...
/* UNCOMMENT DMENUCMD IN KEYS IF YOU USE IT*/
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };

/* REPLACE ST WITH YOUR TERMINAL */
...
/* FLAMESHOT */
/* you can change this to a different screenshot tool if needed */
static const char *scrnsht[] = { "flameshot", "gui", NULL};

/* modkey means we need to use alt + KEY
 * 0 means its just KEY 
 * Shiftmask means we should hold down shift then use key */
